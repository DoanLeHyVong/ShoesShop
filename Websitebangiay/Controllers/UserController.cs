    ...
    public class UserController : Controller
    {
        ...
        public ActionResult Dangky(Nguoidung nguoidung)
        {
            try
            {
                ...
                {
                    SendConfirmationEmail(nguoidung.Email);

                    // Hiển thị thông báo đăng ký thành công
                    ViewBag.regOK = "Đăng kí thành công. Vui lòng kiểm tra email để xác minh tài khoản.";
                    ViewBag.isReg = true;
                    return View("Dangky");
                }
                return View(nguoidung);                            
        ...
        {
            // Tạo đường dẫn xác nhận đăng ký
            string confirmationLink = Url.Action("ConfirmRegistration", "Account", new { email = emailAddress }, Request.Url.Scheme);

            // Tạo nội dung email
            string emailBody = $"Xin chào,\n\nCảm ơn bạn đã đăng ký. Vui lòng nhấp vào liên kết sau để xác nhận đăng ký:\n\n{confirmationLink}";

            // Gửi email
            string fromEmail = "vongdoan9@gmail.com";
